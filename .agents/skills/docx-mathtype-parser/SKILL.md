...
description: Hướng dẫn kỹ thuật và tài liệu chi tiết về hệ thống giải mã file Word (.docx), bóc tách công thức Toán học MathType OLE Binary (MTEF v5/v7), OMML sang LaTeX, font Symbol, bảo vệ mã nguồn LaTeX trong renderRich, Live Render Preview, nhận diện đáp án đúng đa tiêu chí và đồng bộ cơ sở dữ liệu Supabase.
---

# BỘ GIẢI MÃ ĐỀ THI WORD (.DOCX) & MATHTYPE MTEF SANG LATEX

## 📌 Tổng quan
Hệ thống giải mã file đề thi Microsoft Word (`.docx`) tự động hóa 100% quy trình bóc tách đề thi trắc nghiệm và tự luận Toán - Khoa học tự nhiên, giải mã trực tiếp bytecode MathType nhị phân (MTEF v5/v7), font Symbol đặc biệt, chỉ số trên/dưới và đồng bộ hóa với cơ sở dữ liệu Supabase / MathJax Typeset.
