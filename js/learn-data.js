/**
 * Ngân hàng dữ liệu bài học tương tác 5 kỹ năng Tiếng Anh
 * Interactive English Learning Hub Data Bank
 */

export const LEARN_DATA = {
  // =========================================================================
  // 1. LISTENING (LUYỆN NGHE TƯƠNG TÁC)
  // =========================================================================
  listening: [
    {
      id: 'lis_1',
      ...
      audioUrl: '', // Tự động dùng Web Speech Synthesis nếu không có URL file
      speed: 1.0,
      duration: '45s',
      exercises: [
        {
    ...
    },
    {
      ...
      exercises: [
        ...
        {
          type: 'gap_fill',
          sentence: 'Would you like any ___ later? Maybe some ___ afterwards.',
          answers: ['dessert', 'tiramisu'],
          optionsBank: ['dessert', 'tiramisu', 'salad', 'coffee']
        }
      ]
    },
    {
  ...
  // =========================================================================
  // 2. READING (LUYỆN ĐỌC HIỂU TƯƠNG TÁC + TRA TỪ NHANH)
  // =========================================================================
  reading: [
    {
      id: 'read_1',
...
However, the rapid advancement of AI also raises ethical dilemmas. Issues regarding data privacy, algorithmic bias, and potential job displacement in certain sectors require urgent attention from policymakers. To ensure AI benefits humanity as a whole, experts emphasize that technological development must go hand in hand with robust regulatory frameworks and continuous ethical scrutiny.`,
      // Danh mục từ vựng tương tác có thể click trực tiếp trong bài đọc
      vocabulary: {
      ...
      exercises: [
        ...
        },
        {
          ...
          options: [
            'To introduce new AI companies entering the market',
            'To highlight ethical challenges and the need for regulations',
            'To criticize governments for slowing down technology',
            'To predict when AI will replace doctors'
          ],
          answer: 1,
          explain: 'Đoạn cuối tập trung vào các thách thức đạo đức (ethical dilemmas, data privacy, job displacement) và sự cần thiết của quy định (regulatory frameworks).'
        }
      ]
    },
    {
...
Unfortunately, rising ocean temperatures due to climate change have triggered severe coral bleaching events. When the water gets too warm, corals expel the microscopic algae living inside them, turning completely white and starving if conditions do not normalize. Conservationists worldwide are striving to protect this natural treasure through habitat restoration and global climate action.`,
  ...
  // =========================================================================
  // 3. SPEAKING (LUYỆN NÓI & PHÁT ÂM VỚI AI RECOGNITION & PHONETICS)
  // =========================================================================
  speaking: [
    {
      id: 'spk_1',
      ...
      phrases: [
        ...
        },
        {
          ...
          ipa: '/aɪ æm ˈrɪə.li ˈlʊk.ɪŋ ˈfɔː.wəd tuː ˈhɪə.rɪŋ frɒm juː suːn/',
          meaning: 'Tôi rất mong sớm nhận được tin từ bạn.',
          tip: 'Nhớ phát âm đuôi "-ing" trong "looking" và "hearing".'
        },
        {
    ...
    },
    {
      ...
      dialogue: [
        ...
        },
        {
          role: 'Barista (Máy)',
          avatar: '☕',
          text: 'Sure thing! What size would you like: Regular or Large?',
          ipa: '',
          isUser: false
        },
        {
          role: 'You (Học viên nói)',
          avatar: '🧑‍🎓',
          targetText: 'A regular size to take away, please.',
          ipa: '/ə ˈreɡ.jə.lər saɪz tuː teɪk əˈweɪ pliːz/',
          meaning: 'Cho tôi cỡ vừa mang đi nhé.',
          isUser: true
        }
      ]
    }
  ...
  // =========================================================================
  // 4. WRITING (LUYỆN VIẾT TƯƠNG TÁC: SẮP XẾP TỪ, SỬA LỖI, VIẾT LẠI CÂU)
  // =========================================================================
  writing: [
    {
      id: 'wrt_scramble',
      ...
      items: [
        ...
        {
          id: 'sc_3',
          words: ['She', 'suggested', 'taking', 'a', 'short', 'break', 'before', 'continuing.'],
          correctSentence: 'She suggested taking a short break before continuing.',
    ...
    },
    {
      ...
      items: [
        ...
        {
          id: 'err_2',
          incorrectSentence: 'Despite he was exhausted, he completed the marathon.',
          errorWord: 'Despite',
          correctWord: 'Although',
          fullCorrect: 'Although he was exhausted, he completed the marathon.',
          explain: '"Despite + Noun/V-ing", còn ở đây có mệnh đề "he was exhausted" nên phải dùng "Although/Even though".'
        },
        {
          id: 'err_3',
          incorrectSentence: 'Neither John nor his friends is coming to the party tonight.',
          errorWord: 'is',
          correctWord: 'are',
          fullCorrect: 'Neither John nor his friends are coming to the party tonight.',
          explain: 'Cấu trúc "Neither A nor B + Verb" thì động từ chia theo chủ ngữ gần nhất B ("his friends" là số nhiều -> dùng "are").'
        }
      ]
    },
    {
      id: 'wrt_transform',
      title: 'Sentence Transformation (Viết lại câu đồng nghĩa)',
      topic: 'Rephrasing Mastery',
      level: 'B1 - B2',
      items: [
        {
          id: 'tf_1',
          original: 'They built this historic bridge in 1890.',
          givenLead: 'This historic bridge',
          targetKeyWord: 'WAS BUILT',
          targetSentence: 'This historic bridge was built in 1890.',
          hint: 'Chuyển sang câu bị động thì Quá khứ đơn (was/were + V3).'
        },
        {
          id: 'tf_2',
          original: 'I haven’t seen my childhood friend for five years.',
          givenLead: 'The last time I saw',
          targetKeyWord: 'WAS FIVE YEARS AGO',
          targetSentence: 'The last time I saw my childhood friend was five years ago.',
          hint: 'Chuyển đổi giữa Hiện tại hoàn thành và "The last time... was... ago".'
        },
        {
          id: 'tf_3',
          original: '"Don’t forget to turn off the lights," my mother said to me.',
          givenLead: 'My mother reminded me',
          targetKeyWord: 'TO TURN OFF',
          targetSentence: 'My mother reminded me to turn off the lights.',
          hint: 'Cấu trúc tường thuật: remind someone to do something.'
        }
      ]
    }
  ],
  ...
  // =========================================================================
  // 5. LANGUAGE FOCUS (TỪ VỰNG FLASHCARDS 3D & NGỮ PHÁP ĐỐ VUI)
  // =========================================================================
  languageFocus: {
    flashcards: [
      {
      ...
      },
      {
        ...
        pos: 'adjective',
        ipa: '/məˈtɪk.jə.ləs/',
        meaning: 'Tỉ mỉ, cẩn thận đến từng chi tiết nhỏ',
        example: 'He gave meticulous attention to every single equation in his research paper.',
        synonyms: 'Thorough, careful, diligent',
    ...
    matchPairs: [
      ...
      { left: 'Hit the books', right: 'Bắt đầu học chăm chỉ', pairId: 4 },
      { left: 'Under the weather', right: 'Cảm thấy hơi mệt/ốm', pairId: 5 },
      { left: 'Cost an arm and a leg', right: 'Rất đắt đỏ, tốn kém', pairId: 6 }
    ],
